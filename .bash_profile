...
# ngp = notify-git-push
alias ngp="terminal-notifier -title 'GitHub' -message 'Commits have uploaded to remote server!' -sound default"

alias ping_fail="terminal-notifier -title 'Ping failure' -message 'No Internet Connection' -sound Frog"

alias ping_success="terminal-notifier -title 'Ping Success' -message 'Packets have returned!' -sound Frog"
